...
describe('Service Tests', () => {
    ...
    describe('AnomaliaMedidorMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AnomaliaMedidorMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/anomalia-medidors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AnomaliaMedidorMySuffix', () => {
