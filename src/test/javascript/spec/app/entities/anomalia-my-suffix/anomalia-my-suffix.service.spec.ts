...
describe('Service Tests', () => {
    ...
    describe('AnomaliaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AnomaliaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/anomalias';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AnomaliaMySuffix', () => {
