...
describe('Service Tests', () => {
    ...
    describe('InmuebleMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InmuebleMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/inmuebles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InmuebleMySuffix', () => {
