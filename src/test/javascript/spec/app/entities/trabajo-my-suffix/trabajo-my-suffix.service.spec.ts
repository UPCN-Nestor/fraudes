...
describe('Service Tests', () => {
    ...
    describe('TrabajoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TrabajoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/trabajos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TrabajoMySuffix', () => {
