...
@Injectable()
export class MaterialMySuffixPopupService {
            ...
            if (id) {
                this.materialService.find(id)
                    .subscribe((materialResponse: HttpResponse<MaterialMySuffix>) => {
                        const material: MaterialMySuffix = materialResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.materialModalRef(component, new MaterialMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    materialModalRef(component: Component, material: MaterialMySuffix): NgbModalRef {
